...
namespace Ecomteck\Megamenu\Block;
...
/**
 * Class Menu
 * @package Ecomteck\Megamenu\Block
 */
class Menu extends Template implements DataObject\IdentityInterface
{
     ...
     * @var string
     */
    protected $_template = 'Ecomteck_Megamenu::menu.phtml';
    ...
    public function __construct(
        ...
        $this->submenuTemplate = $this->getMenuTemplate(
            'Ecomteck_Megamenu::menu/sub_menu.phtml'
        );
    ...
    {
        return [\Ecomteck\Megamenu\Model\Menu::CACHE_TAG, Block::CACHE_TAG];
    }
    ...
    /**
     * @return array|\Ecomteck\Megamenu\Model\Menu
    ...
    /**
     * @return array|\Ecomteck\Megamenu\Model\Menu|null
     * @throws \Magento\Framework\Exception\NoSuchEntityException
     */
    ...
    {
        $info = [
            \Ecomteck\Megamenu\Model\Menu::CACHE_TAG,
